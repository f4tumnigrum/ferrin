...
| 2026-09-16 | Official crates.io API for `ferrin` and `ferrin-policy` | [Fact] Latest stable `ferrin` is 0.1.1; `ferrin-policy` returns 404 before its first publication. The workspace prepares 0.1.2; publication must be verified separately | Release preparation |
| 2026-09-16 | Ferrin 0.1.2, official crates.io version API and docs.rs status endpoints | [Fact] All 16 versions are published and unyanked; all 16 documentation builds report success. See [release verification](06-versioning-and-release.md#10-release-012-2026-09-16) | Publication verification |
| 2026-09-18 | Official crates.io API for `ferrin`, `ferrin-azure`, `ferrin-voyage` | [Fact] Latest published `ferrin` is 0.1.2; Azure and Voyage return 404 before first publication. Workspace preparation selects 0.2.0 for breaking contracts, with external versions and Rust unchanged | Release preparation |
| 2026-09-18 | Ferrin 0.2.0, official crates.io version API and docs.rs status endpoints | [Fact] All eighteen versions are published and unyanked; all eighteen documentation builds report success. See [release verification](06-versioning-and-release.md#11-release-020-2026-09-18) | Publication verification |

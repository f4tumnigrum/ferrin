...
- Provider capability matrices, settings, and options: [OpenAI](providers/openai.md), [Anthropic](providers/anthropic.md), [Google](providers/google.md), and [OpenAI-compatible endpoints](providers/openai-compatible.md), [Azure OpenAI](providers/azure.md), and [Voyage](providers/voyage.md)

...
| PV-031 | Handwritten provider fixtures versus real responses | Testing section 10 and all four provider guides | Partial verification on 2026-09-17: four OpenAI Responses recordings through a third-party proxy (`gpt-5.6-sol`) pass offline comparison; seven Responses live tests pass. See the OpenAI guide for redactions and proxy differences. Official endpoints, other providers and remaining original fixtures are not verified. | open |
